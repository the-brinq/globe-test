...
```
npm create cloudflare@latest -- --template=cloudflare/templates/globe-test
```

## Preview Deployment

A live public deployment of this template is available at [https://globe-test.templates.workers.dev](https://globe-test.templates.workers.dev)
